...
export const projects: Project[] = [
  {
    ...
    socials: {
      ...
      facebook: "https://facebook.com/REPLACE_VESPA",
      website: "https://REPLACE-VESPA-WEBSITE.com",
      bandcamp: "https://REPLACE-VESPA.bandcamp.com/",
    },
    socialOrder: ["instagram", "spotify", "facebook", "website", "bandcamp"],
    info: {
      label: "Independent",
      pr: "Artist PR",
  ...
  },
  {
    ...
    socials: {
      ...
      bandcamp: "https://offbeataffair.bandcamp.com/",
    },
    socialOrder: ["instagram", "spotify", "facebook", "bandcamp"],
    info: {
      label: "Independent",
  ...
  },
  {
    ...
    socials: {
      ...
      tiktok: "https://www.tiktok.com/@REPLACE_VEEGREEN",
      website: "https://www.veegreen.fr/",
      linkedin: "https://linkedin.com/in/REPLACE_VEEGREEN",
    },
