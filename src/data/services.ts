...
export const services: Service[] = [
  {
    ...
    description: [
      "You’ve got the music. You’ve got the website. But type your genre into Google and... nothing. That’s not a talent problem. It’s a visibility problem.",
      ...
      "We optimize your website structure, content, and metadata so Google actually knows who you are and shows the right people the right story.",
      "And then there’s GEO - Generative Engine Optimization. More and more people are discovering music through AI tools like ChatGPT. If your online presence isn’t built for that, you’re invisible in a whole new way. Most agencies haven’t even heard of GEO yet. We’re already doing it.",
  ...
  },
  {
    ...
    teaser:
      "Real outreach to real journalists and curators who care about your genre. No fake playlists, no pay-for-play blogs. Just honest promotion.",
    description: [
